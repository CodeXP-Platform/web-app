      ...
      <Card className="bg-[#121214] border-white/10 shadow-2xl">
        ...
        <CardContent className="space-y-6">
          <form className="space-y-4">
            ...
            <Button type="button" className="w-full h-11 bg-indigo-500 hover:bg-indigo-600 text-white font-semibold rounded-md transition-colors mt-2 text-sm">
              Sign In
            </Button>
          </form>
          ...
          <div className="grid grid-cols-2 gap-4">
            <Button variant="outline" className="h-11 border-white/10 bg-white/5 hover:bg-white/10 text-white font-medium">
