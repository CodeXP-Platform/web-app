            ...
            <main className="pt-32 pb-24 px-6 md:px-12 max-w-7xl mx-auto flex flex-col items-center">
                ...
                <div className="flex flex-col items-center text-center max-w-4xl mx-auto space-y-8 mt-12 mb-24">
                    ...
                    <p className="text-lg md:text-xl text-zinc-400 max-w-2xl font-light">
                        The ultra-fast, AI-native IDE designed to augment your
                        intelligence and ship production-grade software in
                        record time.
                    </p>
                    ...
                    <div className="flex flex-col sm:flex-row items-center gap-4 pt-4">
                        ...
                        <Link href={paths.dashboard.root}>
                            <Button
                                variant="outline"
                                className="h-12 px-8 text-base font-medium rounded-md border-white/10 hover:bg-white/5 text-white bg-transparent"
                            >
                                <svg
                ...
                <div className="w-full mt-32 mb-24 space-y-12">
                    <div className="text-left max-w-2xl">
                        ...
                        <p className="text-lg text-zinc-400">
                            Tools that feel like an extension of your thought
                            process.
                        ...
                        <Card className="md:col-span-2 bg-[#121214] border-white/5 overflow-hidden flex flex-col justify-between group/card">
                            <CardHeader className="p-8 pb-4">
                                ...
                                <CardDescription className="text-base text-zinc-400 mt-2 max-w-md">
                                    Our AI doesn't just read files; it
                                    understands your entire system architecture.
                                    Ask complex questions across service
                                    boundaries and get precise, contextual
                                    answers.
                                </CardDescription>
                            </CardHeader>
                        ...
                        <div className="flex flex-col gap-6 md:col-span-1">
                            ...
                            <Card className="flex-1 bg-[#121214] border-white/5 p-8 flex flex-col group/card">
                                ...
                                <p className="text-sm text-zinc-400">
                                    Ultra-low latency collaboration. Code
                                    together as if you were on the same machine.
                                </p>
                            </Card>
                            ...
                            <Card className="flex-1 bg-[#121214] border-white/5 p-8 flex flex-col group/card">
                                ...
                                <p className="text-sm text-zinc-400">
                                    Turn mastery into a quest. Earn badges and
                                    track your technical growth across
                                    languages.
                                </p>
                            </Card>
                        </div>
                        ...
                        <Card className="md:col-span-3 bg-[#121214] border-white/5 p-8 flex flex-col md:flex-row items-start md:items-center justify-between gap-8 group/card">
                            <div className="max-w-2xl">
                                ...
                                <p className="text-base text-zinc-400">
                                    Your code remains yours. CodeXP features
                                    local-only inference options, air-gapped
                                    deployments, and zero-knowledge data
                                    retention policies. SOC2 Type II compliant
                                    by default.
                                </p>
                            </div>
                ...
                <div className="w-full py-16 border-y border-white/5 grid grid-cols-2 md:grid-cols-4 gap-8 text-center my-12">
                    <div>
                        <p className="text-4xl md:text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-indigo-500 mb-2">
                            10M+
                        </p>
                    ...
                    <div>
                        <p className="text-4xl md:text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-pink-400 to-rose-500 mb-2">
                            15ms
                        </p>
                        <p className="text-xs font-bold text-zinc-500 tracking-widest uppercase">
                            Avg. Latency
                ...
                <div className="w-full mt-32 flex flex-col items-center">
                    <div className="text-center max-w-3xl mb-16">
                        ...
                        <p className="text-lg text-zinc-400">
                            Transform your computer science curriculum. Deploy a
                            gamified, AI-driven software engineering lab that
                            bridges the gap between theory and industry.
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full mb-12">
                        <Card className="bg-[#121214] border-white/5 p-8 flex flex-col hover:border-white/10 transition-colors">
                            ...
                            <h3 className="text-xl font-semibold text-white mb-3">
                                AI Teaching Assistant 24/7
                            </h3>
                            <p className="text-sm text-zinc-400 leading-relaxed">
                                Our Socratic AI mentor guides students through
                                complex architectural decisions and debugging
                                without just handing them the answers,
                                drastically reducing professor grading loads.
                            </p>
                        </Card>
                        ...
                        <Card className="bg-[#121214] border-white/5 p-8 flex flex-col hover:border-white/10 transition-colors">
                            ...
                            <p className="text-sm text-zinc-400 leading-relaxed">
                                Move beyond console scripts. Students learn to
                                build production-grade microservices, atomic
                                state managers, and distributed systems directly
                                within our sandboxed cloud environments.
                            </p>
                        </Card>
                        ...
                        <Card className="bg-[#121214] border-white/5 p-8 flex flex-col hover:border-white/10 transition-colors">
                            ...
                            <p className="text-sm text-zinc-400 leading-relaxed">
                                Built-in XP systems, custom quests, and
                                university-wide leaderboards keep engineering
                                students highly engaged and coding consistently
                                every single day.
                            </p>
                        </Card>
                        ...
                        <Card className="bg-[#121214] border-white/5 p-8 flex flex-col hover:border-white/10 transition-colors">
                            ...
                            <p className="text-sm text-zinc-400 leading-relaxed">
                                Say goodbye to "it works on my machine" issues.
                                Our cloud instances provision instantly,
                                allowing students to start coding on day one
                ...
                <div className="w-full mt-32 mb-32 flex flex-col items-center">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full">
                        <Card className="bg-[#121214] border-white/5 p-8 flex flex-col justify-between min-h-[250px]">
                            <div>
                                <svg
                                    className="w-8 h-8 text-indigo-500/30 mb-6"
                                    fill="currentColor"
                                    viewBox="0 0 24 24"
                                >
                                ...
                                <p className="text-base text-zinc-300 italic mb-8">
                                    "CodeXP doesn't just help me write code; it
                                    helps me think. The AI context is so deep it
                                    feels like collaborating with a senior
                                    architect who knows my whole stack."
                                </p>
                            </div>
                        ...
                        <Card className="bg-[#121214] border-white/5 p-8 flex flex-col justify-between min-h-[250px]">
                            <div>
                                <svg
                                    className="w-8 h-8 text-purple-500/30 mb-6"
                                    fill="currentColor"
                                    viewBox="0 0 24 24"
                                >
                                    <path d="M14.017 21v-7.391c0-5.704 3.731-9.57 8.983-10.609l.995 2.151c-2.432.917-3.995 3.638-3.995 5.849h4v10h-9.983zm-14.017 0v-7.391c0-5.704 3.748-9.57 9-10.609l.996 2.151c-2.433.917-3.996 3.638-3.996 5.849h3.983v10h-9.983z" />
                                ...
                                <p className="text-base text-zinc-300 italic mb-8">
                                    "The transition from VS Code was seamless,
                                    but the productivity gain was immediate.
                                    We've reduced our sprint cycles by 30% since
                                    adopting the CodeXP framework."
                                </p>
                            </div>
                            <div className="flex items-center gap-4">
                        ...
                        <Card className="bg-[#121214] border-white/5 p-8 flex flex-col justify-between min-h-[250px]">
                            <div>
                                <svg
                                    className="w-8 h-8 text-pink-500/30 mb-6"
                                    fill="currentColor"
                                    viewBox="0 0 24 24"
                                >
                                    <path d="M14.017 21v-7.391c0-5.704 3.731-9.57 8.983-10.609l.995 2.151c-2.432.917-3.995 3.638-3.995 5.849h4v10h-9.983zm-14.017 0v-7.391c0-5.704 3.748-9.57 9-10.609l.996 2.151c-2.433.917-3.996 3.638-3.996 5.849h3.983v10h-9.983z" />
                                ...
                                <p className="text-base text-zinc-300 italic mb-8">
                                    "Security was our main concern with AI.
                                    CodeXP's local-inference mode gave our
                                    compliance team peace of mind while giving
                                    our devs superpowers."
                                </p>
                            </div>
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-zinc-500">
                                        Head of Security, FinTech Global
                                    </p>
                                </div>
                            </div>
                        </Card>
                ...
                <div className="w-full relative overflow-hidden rounded-3xl bg-gradient-to-b from-[#121214] to-[#0a0a0c] border border-white/10 p-12 md:p-24 text-center my-12">
                    ...
                    <p className="text-lg text-zinc-400 mb-10 max-w-2xl mx-auto relative z-10">
                        Join the next generation of engineers building the
                        world's most complex software at the speed of thought.
                    </p>
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4 relative z-10">
                        ...
                        <Button
                            variant="outline"
                            className="h-12 px-8 text-base font-medium rounded-md border-white/10 hover:bg-white/5 text-white bg-transparent w-full sm:w-auto"
                        >
                            Contact Sales
                        </Button>
                    </div>
                ...
                <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-5 gap-12 mb-16">
                    <div className="md:col-span-2">
                        ...
                        <p className="text-sm text-zinc-400 max-w-sm mb-6 leading-relaxed">
                            The world's most advanced AI-integrated coding
